      ...
      <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
        ...
        <div>
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-muted-foreground ml-1">{project.members}</span>
          </div>
        </div>
        <div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-6">
              {[
                ...
                <div key={index} className="profile-card hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <div className="space-y-6">
              <div className="profile-card">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="font-medium text-foreground">Auto-assign Tasks</div>
                      <div className="text-sm text-muted-foreground">
